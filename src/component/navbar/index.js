  ...
  return (
    ...
    <nav className= "navbar" style={{overflow:'hidden'}}>
      <div className="container">
        <div>
         <a href="/" style={{display:'flex',textDecoration:'none'}}><h2 style={{color:'#F5A425',paddingLeft:'10px',alignSelf:'center'}}>PHOTO </h2><h2 style={{color:'#FFFFFF',paddingLeft:'10px',alignSelf:'center'}}> GALLARY</h2></a>
        </div>
        <div  className='login' >
